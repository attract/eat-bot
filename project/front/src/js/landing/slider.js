...
function Peppermint(a, b) {
    ...
    function d(a) {
        var b = ["Webkit", "Moz", "O", "ms"], c = document.createElement("div");
        if (void 0 !== c.style[a]) return !0;
        a = a.charAt(0).toUpperCase() + a.slice(1);
        for (var d in b) if (void 0 !== c.style[b[d] + a]) return !0;
        return !1
    }
    ...
    function i(a, b) {
        ...
        var c = +new Date, d = C.left;
        B = setInterval(function () {
            function e(a, b) {
                return (b - a) * i + a
            }

            var f, g, h = +new Date - c, i = h / b, k = [0, .7, 1, 1];
    ...
    function t() {
        EventBurrito(y, {
            mouse: F.mouseDrag, start: function () {
                e(a, G.drag)
            }, move: function (a, b, c) {
                p(), c.x = c.x / (!E && c.x > 0 || E == v - 1 && c.x < 0 ? Math.abs(c.x) / C.width * 2 + 1 : 1), h(c.x - C.width * E)
            }, end: function (b, c, d) {
                if (d.x) {
                    var e = Math.abs(d.x) / C.width, h = Math.floor(e) + (e - Math.floor(e) > .25 ? 1 : 0),
    ...
    function u() {
        var b = F.slidesContainer || a, c = F.dotsContainer || a;
        if (!(F.disableIfOneSlide && b.children.length <= 1)) {
            ...
            for (var d = 0, l = b.children.length; l > d; d++) {
                var m = b.children[d], o = document.createElement("li");
                C.slides.push(m), o.setAttribute("tabindex", "0"), o.setAttribute("role", "button"), o.innerHTML = "<span></span>", function (b, c) {
                    s(c, "click", function () {
    ...
    var v, w, x, y, z, A, B, C = {slides: [], dots: [], left: 0}, D = 200, E = 0, F = {
        speed: 300,
        touchSpeed: 300,
        slideshow: !1,
    ...
    return u(), {
        ...
        }, next: l, prev: m, start: n, stop: q, pause: p, getCurrentPos: function () {
            return E
...
function EventBurrito(a, b) {
    ...
    function g(a) {
        if (r = {
            ...
            }, t.length >= 5 && t.shift(), t.push({x: r.x, y: r.y, time: r.time})
        }
    }
    ...
    function h(a, b) {
        ...
        }, n = void 0, r = {x: 0, y: 0, time: 0}, s = {x: 0, y: 0}, t = [{x: 0, y: 0, time: 0}], m.start(a, q))
    }
    ...
    var n, o,
        ...
        q = {}, r = {}, s = {}, t = [], u = [], v = !0, w = p.pointerEvents ? 1 : p.msPointerEvents ? 2 : 0,
